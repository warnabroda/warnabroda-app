var Env = {
  ...
  default_vars: {
  	...
  	warn_bies: [ { id: 1, name: "E-Mail", checked: false, url: "http://192.168.1.181:4000/warn_bies/1.json" }, { id: 2, label: "SMS", checked: false, url: "http://192.168.1.181:4000/warn_bies/2.json" }, { id: 3, label: "WhatsApp", checked: true, url: "http://192.168.1.181:4000/warn_bies/3.json" } ]
  }
}
